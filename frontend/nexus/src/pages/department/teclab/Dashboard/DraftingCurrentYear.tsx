...
function DraftingCurrentYear({ responseData }: { responseData: { CURRENT_YEAR?: { PIECHARTDATA?: PieChartServerData, BARCHARTDATA?: BarChartServerData, VALUE?: string } } }) {
...
export default DraftingCurrentYear;
