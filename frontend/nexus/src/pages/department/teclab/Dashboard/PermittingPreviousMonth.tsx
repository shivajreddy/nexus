...
function PermittingPreviousMonth({ responseData }: { responseData: { PREVIOUS_MONTH?: { PIECHARTDATA?: PieChartServerData, BARCHARTDATA?: BarChartServerData, VALUE?: string } } }) {
    ...
    // console.log("PermittingPreviousMonth pieChartData", pieChartData);
    // console.log("PermittingPreviousMonth barChartData", barChartData);

    useEffect(() => {
        if (responseData?.PREVIOUS_MONTH && responseData.PREVIOUS_MONTH?.PIECHARTDATA && responseData.PREVIOUS_MONTH?.BARCHARTDATA) {
            const pieRaw: PieChartServerData = responseData.PREVIOUS_MONTH.PIECHARTDATA;
            const barRaw: BarChartServerData = responseData.PREVIOUS_MONTH.BARCHARTDATA;
...
export default PermittingPreviousMonth;
