...
function DraftingPreviousMonth({ responseData }: { responseData: { PREVIOUS_MONTH?: { PIECHARTDATA?: PieChartServerData, BARCHARTDATA?: BarChartServerData, VALUE?: string } } }) {
...
export default DraftingPreviousMonth;
