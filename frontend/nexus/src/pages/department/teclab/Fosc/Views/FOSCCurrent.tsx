...
function FOSCCurrent() {
    ...
    useEffect(() => {
        const get_lots_data_from_server = async () => {
            try {
                const response = await axios.get('/department/teclab/fosc/current');
                    ...
                    <div className="border-r flex items-center">
                        ...
                        {fetchLotDataStatus === 'loading' ?
                            ...
                            : fetchLotDataStatus === 'failed' ?
                                ...
                                :
                                <p className="ml-4 font-semibold text-primary text-xl">Current-Lots</p>
                        }
                    </div>
