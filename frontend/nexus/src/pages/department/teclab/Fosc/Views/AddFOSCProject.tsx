...
import FOSCAddDataForm from "@pages/department/teclab/Fosc/Views/FOSCAddDataForm.tsx";
// import {ScrollArea} from "@components/ui/scroll-area.tsx";
import ProjectFinderWithResults from "@pages/Project/ProjectFinderWithResults.tsx";


function AddFOSCProject() {
    ...
    return (
        <MainLayout>
            <div className="border rounded bg-default-bg2 m-4 pb-2">
                ...
                {chosenProject &&
                  <FOSCAddDataForm className="ml-4 pt-2"
