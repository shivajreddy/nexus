  ...
  useEffect(() => {
    async function getData() {
      ...
      setFormData({
        ...
        all_field_ops_members: fieldOpsMembers,
    ...
    const fetchSelectedProjectTECLabFOSCData = async () => {
      ...
      try {
        ...
        const transformedData: TECLabFOSCData = {
          ...
          // home-siting-info
          homesiting_completed_by: lotData.homesiting_completed_by ? new Date(lotData.homesiting_completed_by) : undefined,
            ...
            <div className="min-w-[27%]">
              ...
              <Card className="m-4">
                <CardHeader>
                  ...
                  <CardDescription>Homesiting for the lot</CardDescription>
                </CardHeader>
                <CardContent>
                  <FieldDate id="homesiting_requested_on"
                    name="Requested On"
                    value={selectedProjectsTECLabFOSCData.homesiting_requested_on}
                    onUpdate={newDate => handleStateChange('homesiting_requested_on', newDate)}
                  />
                  <FieldDate id="homesiting_completed_on"
                    name="Completed On"
